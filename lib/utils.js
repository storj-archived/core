...
module.exports.calculateBucketId = function(user, bucketName) {
  var hmac = crypto.createHmac('sha512', user);
  var hash = hmac.update(bucketName).digest('hex');
...
module.exports.calculateFileId = function(bucket, fileName) {
  var hmac = crypto.createHmac('sha512', bucket);
  var hash = hmac.update(fileName).digest('hex');
  return hash.substring(0, 24);
};
