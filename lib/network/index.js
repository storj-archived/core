...
/*
** NB: YOU ARE ENTERING REFACTOR ZONE
*/
...
Network.prototype.join = function(callback) {
  ...
  async.each(seeds, function(contact, next) {
    ...
    var topics = self._options.opcodes;

    if (topics.length) {
      topics.forEach(function(topic) {
        // TODO: Filter opcodes by prefix to determine how to handle them
        // TODO: Negotiate contract should probably go in abstract#FarmerFactory
...
Network.prototype.audit = function(hash, callback) {
  // TODO: This should probably go in the abstract#RenterFactory
...
Network.prototype._negotiateContract = function(contract) {
  // TODO: This should probably go in the abstract#FarmerFactory
...
Network.prototype._publish = function(contract) {
  // TODO: This should probably go in the abstract#RenterFactory
  // TODO: But be replaced here with a generic public publish method
