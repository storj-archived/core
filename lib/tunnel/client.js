...
TunnelClient.prototype.open = function() {
  ...
  this._tunnel = new WebSocketClient(this._uri);
...
TunnelClient.prototype._handleDataChannel = function(/* object */) {
  // TODO: Handle proxying the data channel by opening a socket to the target
  // TODO: (locally) if it is not already opened and forward the frames along.
  // TODO: In addition, forward frames received back through to the multiplexer
  // TODO: and up the tunnel.
};
