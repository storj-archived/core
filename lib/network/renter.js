...
/**
 * Publishes a contract directly to a specific contact and receive a
 * storage offer in the response.
 * @param {Contract} contact - The contact to publish the contract
 * @param {Contract} contract - The storage contract to publish
 */
RenterInterface.prototype.publishContract = function(contact, contract, callback) {
