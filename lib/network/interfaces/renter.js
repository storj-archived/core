 ...
 * @param {String} dataHash - The hash of the data
 * @param {RenterInterface~endContractNegotiationCallback}
 */
RenterInterface.prototype.endContractNegotiation = function(hash, callback) {
...
/**
 * @callback RenterInterface~endContractNegotiationCallback
 * @param {Error} [error]
