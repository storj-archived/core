...
RenterInterface.prototype.publishContract = function(contact, contract) {
  ...
  const params = {
      ...
      contents: data,
      publishers: [nodeID],
      ttl: 0, // This message doesn't need to be relayed
    contact: this.contact
  }

  // TODO consider using CLAIM here instead that includes token to upload
  // data, so that another call isn't needed.
