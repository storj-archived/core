...
Transport.prototype._open = function(callback) {
  ...
  self._forwardPort(self._contact.port, function(err, ip, port) {
    self._isPublic = !err;
 ...
 * @param {Function} callback
 */
Transport.prototype._getPort = function(port, callback) {
  var self = this;
 ...
 * @param {Function} callback
 */
Transport.prototype._forwardPort = function(port, callback) {
  var self = this;

  self._getPort(port, function(err, port) {
      if (err) {
