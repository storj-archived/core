...
module.exports.isValidHDNodeID = function(hdNodeID) {
  return typeof hdNodeID === 'string' && hdNodeID.length === 130 &&
    /^[0-9a-fA-F]+$/.test(hdNodeID);
};

module.exports.isValidInt32 = function(n) {
  return !Number.isNaN(n) && (parseInt(n) === n) && n >= 0 &&
    n <= constants.MAX_32INT;
};
