...
FarmerInterface.prototype._shouldSendOffer = function(contract) {
  this._logger.debug('_shouldSendOffer (pendingOffers.length): ', (this._pendingOffers.length < this._options.concurrency));
  this._logger.debug('_shouldSendOffer (negotiator(contract)): ', (this._negotiator(contract) === true));
  this._logger.debug('_shouldSendOffer (hasFreeSpace): ', this._hasFreeSpace);
  this._logger.debug('_shouldSendOffer (pendingOffers): ', JSON.stringify(this._pendingOffers));
