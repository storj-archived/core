  ...
  bridges: [
    {
      ...
      extendedKey: process.env.STORJ_BRIDGE_KEY || 'xpub6AHweYHAxk1EhJSBctQD1nLWPog6Sy2eTpKQLExR1hfzTyyZQWvU4EYNXv1NJN7GpLYXnDLt4PzN874g6zSjAQdFCHZN7U7nbYKYVDUzD42'
    }
  ],
  seedList: [],
...
Network.prototype._enterOverlay = function(onConnected) {
  ...
  // TODO use this._options.bridges instead
  ...
  // TODO bridgeClient can be the first bridge for the time being,
  // this will not be needed later, or can get from multiple bridges.
...
Network.prototype._initNetworkInterface = function() {
  ...
  // TODO there can be multiple bridges
  ...
  this.transport = new Transport(this.contact, {
    ...
    bridgeClient: this._bridgeClient, // TODO there can be multiple bridges
