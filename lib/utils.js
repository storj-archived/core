...
module.exports.calculateBucketId = function(user, bucketName) {
  ...
  var userHash = sha256(user, 'utf-8');
  var bucketHash = sha256(bucketName, 'utf8');
  var hash = sha256(userHash + bucketHash, 'utf-8');
...
module.exports.calculateFileId = function(bucket, fileName) {
  var sha256 = module.exports.sha256;
  var bucketHash = sha256(bucket, 'utf-8');
  var fileHash = sha256(fileName, 'utf8');
  var hash = sha256(bucketHash + fileHash, 'utf-8');
  return hash.substring(0, 24);
};
