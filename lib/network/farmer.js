...
function FarmerInterface(options) {
  ...
  this._protocol.handleClaim = this.handleClaim.bind(this);
}
...
FarmerInterface.prototype.connectBridges = function() {
  // TODO
  // - check if contact is already at each bridge
  // - for bridges that do not have the contact queue a task to add the contact
  // - for bridges that have the contact but the details are incorrect, update the details
  // - for bridges with correct contact info, continue
};

FarmerInterface.prototype.connectBridge = function() {
  // TODO
  // - get a contact challenge from the bridge
  // - perform pow on the challenge
  // - add the contact to the bridge
}

FarmerInterface.prototype.completeChallenge = function() {
  // TODO
  // - do lots of hashing in child process until target difficulty is met
}

FarmerInterface.prototype.bridgeRequest = function() {
  // TODO
  // - create sighash for the request
  // - sign the sighash
  // - add correct headers to the request
  // - send request to the bridge
}

FarmerInterface.prototype.getRequestSigHash = function() {
  // TODO
  // - create hash digest with
  //   - method
  //   - url
  //   - timestamp
  //   - rawbody
...
FarmerInterface.prototype.signRequest = function() {
  // TODO
  // - sign sighash with secp256k1
}

FarmerInterface.prototype.updateBridge = function() {
  // TODO
  // - send request with updated details
}
 ...
 */
FarmerInterface.prototype.handleClaim = function(params, callback) {
  var self = this;
