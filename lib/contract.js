...
class Contract {
   ...
   */
  verify(actor, pubkey) {
    return this.verifyExternal(this.get(actor + '_signature'), pubkey);
  }
  ...
  signExternal(secret) {
    ...
    return secp256k1.sign(this.getSigningData(), secret);
  }
  ...
  verifyExternal(signature, pubkey) {
    ...
    return secp256k1.verify(this.getSigningData(), signature, pubkey);
  }
