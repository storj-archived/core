...
var TunnelClient = require('./client');
 ...
 * @param {TunnelGateway|TunnelClient} source - Tunnel gateway to bind
...
TunnelMuxer.prototype.source = function(source) {
  ...
  assert(
    source instanceof TunnelGateway || source instanceof TunnelClient,
    'Source must be a tunnel gateway or client'
  );
